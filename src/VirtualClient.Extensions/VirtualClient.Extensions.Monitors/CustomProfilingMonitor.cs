namespace CRC.VirtualClient.Extensions
{
    ...
    /// 
    /// </summary>
    public class CustomProfilingMonitor : VirtualClientComponent
    {
        ...
        /// </param>
        public CustomProfilingMonitor(IServiceCollection dependencies, IDictionary<string, IConvertible> parameters = null)
